...
import (
	...
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/cache"
	ddosProtection "github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/ddos-protection"
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/dns"
	firewallActions "github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/firewall-actions"
	globalServerConfig "github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/global-server-config"
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/health"
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/metrics"
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/services"
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/waf"
	"github.com/dashenmiren/EdgeAdmin/internal/web/actions/default/clusters/cluster/settings/webp"
